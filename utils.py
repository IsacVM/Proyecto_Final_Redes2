...
def target_revisar_conexion_vecino(DISPOSITIVO_ID,indice_vecino):
  ...
  vector_distancia=DICT_DATOS_PARTICULARES_POR_DISPOSITIVO.get(DISPOSITIVO_ID).get("VECTOR_RENGLON_PESOS")[0]
  vector_distancia_nombres=DICT_DATOS_PARTICULARES_POR_DISPOSITIVO.get(DISPOSITIVO_ID).get("VECTOR_RENGLON_PESOS")[1]
